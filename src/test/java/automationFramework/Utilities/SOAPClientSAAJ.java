...
public class SOAPClientSAAJ {
	...
	public static final String ABP_HOST_NAME = "10.252.3.21";
	...
	public String createABPAccountSOAPCall(String pan) {
		// ######################################################################
		// ##### REQUEST PARAMETERS
		// ######################################################################
		String transitAccountId;
		String loadAmount = "2800";
		...
		String sectorId = "1";
		String serviceType = "1";
		String tapPurpose = "Exit";
		int tapSequence = 0;
		String tokenExpirationDate = expirationDate + "-31" + "T08:00:00Z";
		String tokenType = "Bankcard";
		int transactionId = 0;
		 ...
		 * System.out.println(
		 * "\n######################################################################"
		 * ); System.out.println("PostTap (EXIT)"); stopId = "2"; request =
		 * createReqPostTap(DEVICE_ID, stopId, routeId, zoneId, operatorId,
		 * directionId, sectorId, serviceType, "Exit", ++tapSequence, pan,
		 * tokenExpirationDate, tokenType, createNowZuluDTM(), ++transactionId);
		 * response = sendSOAPReq(request, soapAction, reqURL); responseCode =
		 * getRespValue(response, "ResponseCode"); System.out.println(
		 * "ResponseCode: " + responseCode); // assert(responseCode ==
		 * "Successful");
		 * 
		 */
	...
	// load value based on pan
	public void loadValueSOAPCall(String pan) {
		// ######################################################################
		// ##### REQUEST PARAMETERS
		// ######################################################################
		String transitAccountId;
		...
		responseCode = getRespValue(response, "ResponseCode");
		System.out.println("ResponseCode: " + responseCode);
		System.out.println("Load Value SOAP Call Completed!");

	}

	// create a tap based on pan
	public void postTapSOAPCall(String pan) {
		...
		System.out.println("Post Tap SOAP Call Completed!");
